...
public class LoanProductController {
    ...
    public ResponseEntity<LoanProductResponseDTO> getProductById(@PathVariable Long id) {
        spectraLogger.info("LOAN_PRODUCT_FETCH_REQUEST").attr("productId", id).log();
        LoanProductResponseDTO product = productService.getProductById(id);
        spectraLogger.info("LOAN_PRODUCT_FETCH_SUCCESS").attr("productId", id).log();
    ...
    public ResponseEntity<Void> deleteProduct(@PathVariable Long id) {
        spectraLogger.info("LOAN_PRODUCT_DELETE_REQUEST").attr("productId", id).log();
