...
import in.zeta.microloan.platform.exception.EventPublishingException;
import in.zeta.oms.atropos.client.AtroposPublisherClient;
import in.zeta.oms.atropos.exception.BadRequestException;
...
public class EventProducer {
    ...
    public EventProducer(
        ...
        try {
            this.publishMode = PublishMode.valueOf(publishModeString.toUpperCase(Locale.ENGLISH));
            ...
            throw new BadRequestException("Unexpected error while getting publish mode"+ e);
        }
    }
    ...
    public CompletionStage<PublishEventResponse> publishEvent(String eventData, String topic) {
        ...
        return atroposPublisherClient.publish(builder, publishMode).thenApply(response -> {
            ...
            logger.error("Error occurred while publishing Event")
                    ...
                    .log();
            throw new EventPublishingException(e.getMessage());
        });
    }
